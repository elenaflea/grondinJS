...
const vingtEtUn = document.querySelector(".vingtEtUn");
const vingtEtUnVingtEtUn = document.querySelector(".vingtEtUnVingtEtUn");
const vingtDeux = document.querySelector(".vingtDeux");
const vingtDeuxVingtDeux = document.querySelector(".vingtDeuxVingtDeux");
const vingtTrois = document.querySelector(".vingtTrois");
const vingtTroisVingtTrois = document.querySelector(".vingtTroisVingtTrois");
const vingtQuatre = document.querySelector(".vingtQuatre");
const vingtQuatreVingtQuatre = document.querySelector(".vingtQuatreVingtQuatre");
const vingtCinq = document.querySelector(".vingtCinq");
const vingtCinqVingtCinq = document.querySelector(".vingtCinqVingtCinq");
const vingtSix = document.querySelector(".vingtSix");
const vingtSixVingtSix = document.querySelector(".vingtSixVingtSix");
...
const vingtEtUnPar = document.querySelector(".vingtEtUnPar");
const vingtDeuxPar = document.querySelector(".vingtDeuxPar");
const vingtTroisPar = document.querySelector(".vingtTroisPar");
const vingtQuatrePar = document.querySelector(".vingtQuatrePar");
const vingtCinqPar = document.querySelector(".vingtCinqPar");
const vingtSixPar = document.querySelector(".vingtSixPar");
...
btnRu.addEventListener("click", () => {
    ...
    vingtEtUn.textContent= "Поиск";
    vingtEtUnVingtEtUn.textContent= "рецептов";
    vingtDeux.textContent= "Список";
    vingtDeuxVingtDeux.textContent= "дел";
    vingtCinq.textContent= "Деловой";
    vingtCinqVingtCinq.textContent= "осьминог";
    vingtSix.textContent= "Список";
    ...
    vingtEtUnPar.textContent= "2.3 миллиона рецептов";
    vingtDeuxPar.textContent= "на день";
    vingtTroisPar.textContent= "изменить будущее";
    vingtQuatrePar.textContent= "чай";
    vingtCinqPar.textContent= "найти занятие";
    vingtSixPar.textContent= "купить до рождения";
    ...
    vingtTrois.textContent= "Консультации";
    vingtTroisVingtTrois.textContent= "по профориентированию";
    vingtQuatre.textContent= "Онлайн";
    vingtQuatreVingtQuatre.textContent= "магазин";
...
btnEn.addEventListener("click", () => { 
    ...
    vingtEtUn.textContent= "Recipe";
    vingtEtUnVingtEtUn.textContent= "search";
    vingtDeux.textContent= "To Do";
    vingtDeuxVingtDeux.textContent= "List";
    vingtCinq.textContent= "Busy";
    vingtCinqVingtCinq.textContent= "octopus";
    vingtSix.textContent= "Baby";
    ...
    vingtEtUnPar.textContent= "2.3 millions recipes";
    vingtDeuxPar.textContent= "day planner";
    vingtTroisPar.textContent= "change your future";
    vingtQuatrePar.textContent= "tea";
    vingtCinqPar.textContent= "Find some activity";
    vingtSixPar.textContent= "to buy before baby is born ";
    ...
    vingtTrois.textContent= "Consulting";
    vingtTroisVingtTrois.textContent= "entreprise";
    vingtQuatre.textContent= "Online";
    vingtQuatreVingtQuatre.textContent= "shop";
...
btnFr.addEventListener("click", () => { 
    ...
    vingtEtUn.textContent= "Recherche de";
    vingtEtUnVingtEtUn.textContent= "Recettes";
    vingtDeux.textContent= "To Do";
    vingtDeuxVingtDeux.textContent= "List";
    vingtCinq.textContent= "Une";
    vingtCinqVingtCinq.textContent= "pieuvre";
    vingtSix.textContent= "Bébé";
    vingtSixVingtSix.textContent= "list";
    ...
    vingtEtUnPar.textContent= "2.3 millions recettes";
    vingtDeuxPar.textContent= "Pour planifier la journée";
    vingtTroisPar.textContent= "Changer votre avenir";
    vingtQuatrePar.textContent= "thé";
    vingtCinqPar.textContent= "trouver une activité";
    vingtSixPar.textContent= "à acheter avant la naissance";
    ...
    vingtTrois.textContent= "Cabinet";
    vingtTroisVingtTrois.textContent= "de conseil";
    vingtQuatre.textContent= "Boutique";
    vingtQuatreVingtQuatre.textContent= "en ligne";
